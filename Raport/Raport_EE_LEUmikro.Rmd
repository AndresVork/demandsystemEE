...
![Joonis. Tarbimiskulutused kvintiilide lõikes](../joonised/LEUkvartaalsedsummadmikro.PNG){width=800px}

Tarbimiskulude osakaalud kogu tarbimiskuludest tarbimiskvintiilide lõikes on toodud järgmisel joonisel.

![Joonis. Tarbimiskulutuste struktuur kvintiilide lõikes](../joonised/LEUkvartaalsedosakaaludmikro.PNG){width=800px}
...
![Joonis. Osakaalud kvintiilide lõikes](../joonised/osakaaljasissetulekkvintiilideloikes2.PNG){width=800px}
...
ggsave(filename = "../joonised/kogukulutusteelastsus.PNG", width = 10, height = 8)
#ggsave(filename = "joonised/kogukulutusteelastsus.PNG", width = 10, height = 8)
...
ggsave(filename = "../joonised/hinnaeelastsus.PNG", width = 10, height = 8)
#ggsave(filename = "joonised/hinnaeelastsus.PNG", width = 10, height = 8)
