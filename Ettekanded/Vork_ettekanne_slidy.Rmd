---
title: "Hinna- ja kogukulude elastsused Eesti andmetel sisend-väljund tabelisse"
subtitle: "Projekt COVID-19 seotud majandusmõjude ning nende pehmendamiseks mõeldud poliitikameetmete tõhususe hindamine"
...
- Idee
    ...
    - Võrdle teiste riikide uuringutega

## Andmed ja metoodika

- Andmed
    - LEU 2000-2007, 2010-2012, 2015-2016 ja 2019-2020
    - Kvartaalne kulutuste struktuur koos või eraldi tarbimiskvintiilide kaupa
    - 12 kaubagruppi
...
- Metoodika
    ...
    - AIDS mudel, kompenseerimata hinnaelastsused ja kogukulutuste elastsus 
- Võrdlus varasemate teiste riikide tulemustega
    - Riikidevaheline paneelandmete põhised analüüsid (Copenhagen Economics (2008), Kratena et al (2017) FIDELIO 2)
...
![Joonis. Tarbimiskulutused kvintiilide lõikes](../joonised/LEUkvartaalsedsummadmikro.PNG){width=1200px}

----

Tarbimiskulude osakaalud tarbimiskuludest tarbimiskvintiilide lõikes

![Joonis. Tarbimiskulutuste struktuur kvintiilide lõikes](../joonised/LEUkvartaalsedosakaaludmikro.PNG){width=1200px}

----

Kasutatavate hinnaindeksite kvartaalne dünaamika.

![Joonis. Hinnaindeksid](../joonised/kvartaalsedhinnaindeksid2.PNG){width=1000px}
...
![Joonis. Hinnaindeksid kvintiilide jaoks](../joonised/kvartaalnestoneihinnaindks.PNG){width=1000px}


## Osakaal sissetulekute ja kvintiilide lõikes

![Joonis. Osakaalud kvintiilide lõikes](../joonised/osakaaljasissetulekkvintiilideloikes2.PNG){width=1000px}
...
![Joonis. Kogukulutuste elastsus](../joonised/kogukulutusteelastsus.PNG){width=1000px}
...
![Joonis. Hinnaelastsused](../joonised/hinnaeelastsus.PNG){width=1000px}

## Teised uuringud

  - Eesti kohta: Võrk, Selliov (2002) toidu- ja mittealkohoolsete jookide kogukulutuste elastsus 0.3-0.4 ja otsene hinnaelastsus ca -0.5. Meil 0.5 ja-0.1 kuni -0.3.
  - Rahvusvahelised uuringud
  
## FIDELIO 2 mudelis kasutatud elastused 

![](../Raport/fidelioelastsused.png){width=1200px}

Allikas: @kratena_fidelio_2017, lk 34

## FIDELIO 2 mudelis kasutatud energia- ja transpordikaupade sissetulekuelastsused

![](../Raport/fidelioenergiasissetulekuelastsused.png){width=1200px}

## Copenhagen economics (2008) sissetuleku- ja hinnaelastused

![](../Raport/copenhageneconomics2008elastsused.png){width=600px}
...
p1 <- ggplot(dfel, aes(x=Hinnaelastsus, y = Kogukuluelastsus, color = Grupp, shape = Allikas, text = Kategooria)) +
...
## Elastsuste ettepanek IO mudelisse
...
Täisraport: https://andresvork.github.io/Raport_EE_LEUmikro.html
